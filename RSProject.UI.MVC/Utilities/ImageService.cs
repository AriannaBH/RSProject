...
namespace RSProject.UI.MVC.Utilities
{
    public class ImageService
    {
        ...
        public static void Delete(string path, string fileName)
        {
            ...
            //****to match YOUR CURRENT DEFAULT IMAGE NAME (ie, if you have a default.jpg as your image)****
            //*****update the if to reflect if (filename.ToLower() == "default.jpg") below    **************
            //**********************************************************************************************
